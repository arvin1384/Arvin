...
# ######################Register######################## #
# ###################################################### #
tk.Label(register , text='First name').grid(row=0 , column=0)
...
DateEntry(
    ...
    foreground='white',
    width=10).grid(row=2 , column=1,  sticky=tk.W+tk.E)
...
tk.Button(register ,
    text='Register' ,
    command= register_btn).grid(row=4 , column = 0 , columnspan=2 , sticky=tk.W+tk.E)

tk.Button(register ,
    text='Cancel' ,
    command= root.destroy).grid(row=5 , column = 0 , columnspan=2 , sticky=tk.W+tk.E)
...
tk.Label(search , text='Birth').grid(row=3 , column=0)
